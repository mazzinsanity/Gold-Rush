...
export const feature_l_arm_markings_1: FeatureChoiced = {
  name: 'c. Left Arm Markings',
  component: FeatureDropdownInput,
};

export const feature_l_arm_markings_1_color_list: Feature<string[]> = {
  name: 'c. Left Arm Markings Colors',
  component: FeatureTriColorInput,
};

export const feature_l_arm_markings_2: FeatureChoiced = {
  name: 'cc. Left Arm Markings 2',
  component: FeatureDropdownInput,
};

export const feature_l_arm_markings_2_color_list: Feature<string[]> = {
  name: 'cc. Left Arm Markings 2 Colors',
  component: FeatureTriColorInput,
};

export const feature_l_arm_markings_3: FeatureChoiced = {
  name: 'ccc. Left Arm Markings 3',
  component: FeatureDropdownInput,
};

export const feature_l_arm_markings_3_color_list: Feature<string[]> = {
  name: 'ccc. Left Arm Markings 3 Colors',
  component: FeatureTriColorInput,
};

export const feature_l_hand_markings_1: FeatureChoiced = {
  name: 'd. Left Hand Markings',
  component: FeatureDropdownInput,
};

export const feature_l_hand_markings_1_color_list: Feature<string[]> = {
  name: 'd. Left Hand Markings Colors',
  component: FeatureTriColorInput,
};

export const feature_l_hand_markings_2: FeatureChoiced = {
  name: 'dd. Left Hand Markings 2',
  component: FeatureDropdownInput,
};

export const feature_l_hand_markings_2_color_list: Feature<string[]> = {
  name: 'dd. Left Hand Markings 2 Colors',
  component: FeatureTriColorInput,
};

export const feature_l_hand_markings_3: FeatureChoiced = {
  name: 'ddd. Left Hand Markings 3',
  component: FeatureDropdownInput,
};

export const feature_l_hand_markings_3_color_list: Feature<string[]> = {
  name: 'ddd. Left Hand Markings 3 Colors',
  component: FeatureTriColorInput,
};

export const feature_r_arm_markings_1: FeatureChoiced = {
  name: 'e. Right Arm Markings',
  component: FeatureDropdownInput,
};

export const feature_r_arm_markings_1_color_list: Feature<string[]> = {
  name: 'e. Right Arm Markings Colors',
  component: FeatureTriColorInput,
};

export const feature_r_arm_markings_2: FeatureChoiced = {
  name: 'ee. Right Arm Markings 2',
  component: FeatureDropdownInput,
};

export const feature_r_arm_markings_2_color_list: Feature<string[]> = {
  name: 'ee. Right Arm Markings 2 Colors',
  component: FeatureTriColorInput,
};

export const feature_r_arm_markings_3: FeatureChoiced = {
  name: 'eee. Right Arm Markings 3',
  component: FeatureDropdownInput,
};

export const feature_r_arm_markings_3_color_list: Feature<string[]> = {
  name: 'eee. Right Arm Markings 3 Colors',
  component: FeatureTriColorInput,
};

export const feature_r_hand_markings_1: FeatureChoiced = {
  name: 'f. Right Hand Markings',
  component: FeatureDropdownInput,
};

export const feature_r_hand_markings_1_color_list: Feature<string[]> = {
  name: 'f. Right Hand Markings Colors',
  component: FeatureTriColorInput,
};

export const feature_r_hand_markings_2: FeatureChoiced = {
  name: 'ff. Right Hand Markings 2',
  component: FeatureDropdownInput,
};

export const feature_r_hand_markings_2_color_list: Feature<string[]> = {
  name: 'ff. Right Hand Markings 2 Colors',
  component: FeatureTriColorInput,
};

export const feature_r_hand_markings_3: FeatureChoiced = {
  name: 'fff. Right Hand Markings 3',
  component: FeatureDropdownInput,
};

export const feature_r_hand_markings_3_color_list: Feature<string[]> = {
  name: 'fff. Right Hand Markings 3 Colors',
  component: FeatureTriColorInput,
};

export const feature_l_leg_markings_1: FeatureChoiced = {
  name: 'g. Left Leg Markings',
  component: FeatureDropdownInput,
};

export const feature_l_leg_markings_1_color_list: Feature<string[]> = {
  name: 'g. Left Leg Markings Colors',
  component: FeatureTriColorInput,
};

export const feature_l_leg_markings_2: FeatureChoiced = {
  name: 'gg. Left Leg Markings 2',
  component: FeatureDropdownInput,
};

export const feature_l_leg_markings_2_color_list: Feature<string[]> = {
  name: 'gg. Left Leg Markings 2 Colors',
  component: FeatureTriColorInput,
};

export const feature_l_leg_markings_3: FeatureChoiced = {
  name: 'ggg. Left Leg Markings 3',
  component: FeatureDropdownInput,
};

export const feature_l_leg_markings_3_color_list: Feature<string[]> = {
  name: 'ggg. Left Leg Markings 3 Colors',
  component: FeatureTriColorInput,
};

export const feature_l_foot_markings_1: FeatureChoiced = {
  name: 'h. Left Foot Markings',
  component: FeatureDropdownInput,
};

export const feature_l_foot_markings_1_color_list: Feature<string[]> = {
  name: 'h. Left Foot Markings Colors',
  component: FeatureTriColorInput,
};

export const feature_l_foot_markings_2: FeatureChoiced = {
  name: 'hh. Left Foot Markings 2',
  component: FeatureDropdownInput,
};

export const feature_l_foot_markings_2_color_list: Feature<string[]> = {
  name: 'hh. Left Foot Markings 2 Colors',
  component: FeatureTriColorInput,
};

export const feature_l_foot_markings_3: FeatureChoiced = {
  name: 'hhh. Left Foot Markings 3',
  component: FeatureDropdownInput,
};

export const feature_l_foot_markings_3_color_list: Feature<string[]> = {
  name: 'hhh. Left Foot Markings 3 Colors',
  component: FeatureTriColorInput,
};

export const feature_r_leg_markings_1: FeatureChoiced = {
  name: 'i. Right Leg Markings',
  component: FeatureDropdownInput,
};

export const feature_r_leg_markings_1_color_list: Feature<string[]> = {
  name: 'i. Right Leg Markings Colors',
  component: FeatureTriColorInput,
};

export const feature_r_leg_markings_2: FeatureChoiced = {
  name: 'ii. Right Leg Markings 2',
  component: FeatureDropdownInput,
};

export const feature_r_leg_markings_2_color_list: Feature<string[]> = {
  name: 'ii. Right Leg Markings 2 Colors',
  component: FeatureTriColorInput,
};

export const feature_r_leg_markings_3: FeatureChoiced = {
  name: 'iii. Right Leg Markings 3',
  component: FeatureDropdownInput,
};

export const feature_r_leg_markings_3_color_list: Feature<string[]> = {
  name: 'iii. Right Leg Markings 3 Colors',
  component: FeatureTriColorInput,
};

export const feature_r_foot_markings_1: FeatureChoiced = {
  name: 'j. Right Foot Markings',
  component: FeatureDropdownInput,
};

export const feature_r_foot_markings_1_color_list: Feature<string[]> = {
  name: 'j. Right Foot Markings Colors',
  component: FeatureTriColorInput,
};

export const feature_r_foot_markings_2: FeatureChoiced = {
  name: 'jj. Right Foot Markings 2',
  component: FeatureDropdownInput,
};

export const feature_r_foot_markings_2_color_list: Feature<string[]> = {
  name: 'jj. Right Foot Markings 2 Colors',
  component: FeatureTriColorInput,
};

export const feature_r_foot_markings_3: FeatureChoiced = {
  name: 'jjj. Right Foot Markings 3',
  component: FeatureDropdownInput,
};

export const feature_r_foot_markings_3_color_list: Feature<string[]> = {
