...
/obj/item/modular_computer/processor/alert_call(datum/computer_file/program/alerter, alerttext)
	if(!alerter || !alerter.alert_able || alerter.alert_silenced || !alerttext)
		return
	playsound(src, 'sound/machines/twobeep_high.ogg', 50, TRUE)
	machinery_computer.visible_message(span_notice("The [src] displays a [alerter.filedesc] notification: [alerttext]"))
