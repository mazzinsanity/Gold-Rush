/datum/species/anthropomorph
	name = "Anthropomorph"
	id = SPECIES_ANTHROPOMORPH
	species_traits = list(MUTCOLORS, EYECOLOR, LIPS, HAS_FLESH, HAS_BONE, MARKINGS, HAIR, FACEHAIR)
...
//I wag in death
/datum/species/anthropomorph/spec_death(gibbed, mob/living/carbon/human/H)
	if(H)
		stop_wagging_tail(H)

/datum/species/anthropomorph/spec_stun(mob/living/carbon/human/H,amount)
	if(H)
		stop_wagging_tail(H)
	. = ..()

/datum/species/anthropomorph/can_wag_tail(mob/living/carbon/human/H)
	return mutant_bodyparts["tail"] || mutant_bodyparts["waggingtail"]

/datum/species/anthropomorph/is_wagging_tail(mob/living/carbon/human/H)
	return mutant_bodyparts["waggingtail"]

/datum/species/anthropomorph/start_wagging_tail(mob/living/carbon/human/H)
...
/datum/species/anthropomorph/stop_wagging_tail(mob/living/carbon/human/H)
...
/datum/species/anthropomorph/on_species_gain(mob/living/carbon/C, datum/species/old_species, pref_load)
...
/datum/species/anthropomorph/randomize_main_appearance_element(mob/living/carbon/human/human_mob)
	var/tail = pick(GLOB.tails_list)
	human_mob.dna.features["tail"] = tail
	mutant_bodyparts["tail"] = tail
	human_mob.update_body()

/datum/species/anthropomorph/get_scream_sound(mob/living/carbon/human/human)
...
/datum/species/anthropomorph/get_species_description()
	return "To do: Write anthropomorph species description."

/datum/species/anthropomorph/get_species_lore()
	return list(
		"To do: Write anthropomorph species lore or why anthros are roaming around in Fallout.",
	)
