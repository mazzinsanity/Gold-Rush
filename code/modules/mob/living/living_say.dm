...
/mob/living/say(message, bubble_type,list/spans = list(), sanitize = TRUE, datum/language/language = null, ignore_spam = FALSE, forced = null, filterproof)
	...
	var/message_range = 10 //MS13 Edit - Default value is 7
...
/mob/living/send_speech(message, message_range = 10, obj/source = src, bubble_type = bubble_icon, list/spans, datum/language/message_language=null, list/message_mods = list()) //MS13 Edit - Default message_range value is 6
