...
#define TAG_DEL(X) "<b>(<A href='byond://?_src_=holder;[HrefToken(TRUE)];del_tag=[REF(X)]'>UNTAG</a>)</b>"
#define TAG_MARK(X) "<b>(<A href='byond://?_src_=holder;[HrefToken(TRUE)];mark_datum=[REF(X)]'>MARK</a>)</b>"
...
/datum/admins/proc/display_tags()
	...
	dat += "<br><A href='byond://?_src_=holder;[HrefToken(TRUE)];show_tags=1'>Refresh</a><br>"
	...
	dat = dat.Join("<br>")
	var/datum/browser/browser = new(src, "tag", "Tag Menu", 800, 480)
