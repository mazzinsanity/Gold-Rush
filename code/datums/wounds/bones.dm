...
/datum/wound/blunt/bone/receive_damage(wounding_type, wounding_dmg, wound_bonus)
	...
	if(ishuman(victim))
		...
		if(HAS_TRAIT(human_victim, TRAIT_NOBLEED))
			return
...
/datum/wound/blunt/bone/moderate
	...
	threshold_penalty = 10 //Original TG value is 15
...
/datum/wound_pregen_data/bone/dislocate
	...
	threshold_minimum = 25	//MOJAVE SUN EDIT - Original TG value is 35
...
/datum/wound/blunt/bone/moderate/treat(obj/item/I, mob/user)
	...
	if(victim == user)
		victim.visible_message(span_danger("[user] begins [scanned ? "expertly" : ""] resetting [victim.p_their()] [limb.name] with [I]."), span_warning("You begin resetting your [limb.name] with [I][scanned ? ", keeping the holo-image's indications in mind" : ""]..."))
	else
		user.visible_message(span_danger("[user] begins [scanned ? "expertly" : ""] resetting [victim]'s [limb.name] with [I]."), span_notice("You begin resetting [victim]'s [limb.name] with [I][scanned ? ", keeping the holo-image's indications in mind" : ""]..."))
...
/datum/wound/blunt/bone/severe
	...
	treat_text = "Recommended light surgical application of bone gel, though a splint will prevent worsening situation."
	...
	threshold_penalty = 25 //Original TG value is 30
	//MOJAVE EDIT CHANGE END
...
/datum/wound_pregen_data/bone/hairline
	...
	threshold_minimum = 55 //MOJAVE SUN EDIT - Original TG value is 60
