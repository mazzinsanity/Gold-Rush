...
/datum/symptom/heal/starlight/Heal(mob/living/carbon/M, datum/disease/advance/A, actual_power)
	...
	var/list/parts = M.get_damaged_bodyparts(1,1, null, BIO_STANDARD)

	if(!parts.len)
		return

	for(var/obj/item/bodypart/L in parts)
		if(L.heal_damage(heal_amt/parts.len, heal_amt/parts.len, null, BIO_STANDARD))
...
/datum/symptom/heal/darkness/Heal(mob/living/carbon/M, datum/disease/advance/A, actual_power)
	...
	for(var/obj/item/bodypart/L in parts)
		if(L.heal_damage(heal_amt/parts.len, heal_amt/parts.len * 0.5, null, BIO_STANDARD)) //more effective on brute
			M.update_damage_overlays()
	return 1
...
/datum/symptom/heal/water/Heal(mob/living/carbon/M, datum/disease/advance/A, actual_power)
	...
	var/list/parts = M.get_damaged_bodyparts(1,1, null, BIO_STANDARD) //more effective on burns
	...
	for(var/obj/item/bodypart/L in parts)
		if(L.heal_damage(heal_amt/parts.len * 0.5, heal_amt/parts.len, null, BIO_STANDARD))
			M.update_damage_overlays()
