...
/proc/make_datum_references_lists()
	//hair
	init_sprite_accessory_subtypes(/datum/sprite_accessory/hair, GLOB.hairstyles_list, GLOB.hairstyles_bald_list, GLOB.hairstyles_short_list, GLOB.hairstyles_medium_list, GLOB.hairstyles_long_list) //MOJAVE SUN EDIT - Hair Length
	//facial hair
	...
	init_sprite_accessory_subtypes(/datum/sprite_accessory/markings/head, GLOB.head_markings_list)
	init_sprite_accessory_subtypes(/datum/sprite_accessory/markings/chest, GLOB.chest_markings_list)
	init_sprite_accessory_subtypes(/datum/sprite_accessory/markings/left_arm, GLOB.left_arm_markings_list)
	init_sprite_accessory_subtypes(/datum/sprite_accessory/markings/left_hand, GLOB.left_hand_markings_list)
	init_sprite_accessory_subtypes(/datum/sprite_accessory/markings/right_arm, GLOB.right_arm_markings_list)
	init_sprite_accessory_subtypes(/datum/sprite_accessory/markings/right_hand, GLOB.right_hand_markings_list)
	init_sprite_accessory_subtypes(/datum/sprite_accessory/markings/left_leg, GLOB.left_leg_markings_list)
	init_sprite_accessory_subtypes(/datum/sprite_accessory/markings/left_foot, GLOB.left_foot_markings_list)
	init_sprite_accessory_subtypes(/datum/sprite_accessory/markings/right_leg, GLOB.right_leg_markings_list)
	init_sprite_accessory_subtypes(/datum/sprite_accessory/markings/right_foot, GLOB.right_foot_markings_list)
	...
	init_sprite_accessory_subtypes(/datum/sprite_accessory/mushcap, GLOB.mushcaps_list)
