...
GLOBAL_LIST_INIT(traits_by_type, list(
	...
	/atom/movable = list(
		...
		"TRAIT_DUSTSTORM_IMMUNE" = TRAIT_DUSTSTORM_IMMUNE, //MOJAVE MODULE OUTDOOR_EFFECTS
		"TRAIT_RAINSTORM_IMMUNE" = TRAIT_RAINSTORM_IMMUNE, //MOJAVE MODULE OUTDOOR_EFFECTS
