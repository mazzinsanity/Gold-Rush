...
#define TOGGLES_DEFAULT (SOUND_ADMINHELP|SOUND_MIDI|SOUND_AMBIENCE|SOUND_LOBBY|SOUND_ENDOFROUND|MEMBER_PUBLIC|SOUND_INSTRUMENTS|SOUND_PRAYERS|SOUND_ANNOUNCEMENTS|SOUND_COMBATMODE) //MOJAVE SUN EDIT - Removes "Ship Ambience"
