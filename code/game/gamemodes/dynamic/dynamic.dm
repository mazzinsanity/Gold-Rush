...
/datum/game_mode/dynamic/admin_panel()
	...
	dat += "Latejoin: [DisplayTimeText(latejoin_injection_cooldown-world.time)] <a href='byond://?src=\ref[src];[HrefToken()];injectlate=1'>Now!</a><BR>"
	dat += "Midround: [DisplayTimeText(midround_injection_cooldown-world.time)] <a href='byond://?src=\ref[src];[HrefToken()];injectmid=1'>Now!</a><BR>"
