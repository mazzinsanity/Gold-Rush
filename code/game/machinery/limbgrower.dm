...
/obj/machinery/limbgrower
	...
	var/list/categories = list(SPECIES_HUMAN, SPECIES_LIZARD, SPECIES_ANTHROPOMORPH, SPECIES_MOTH, SPECIES_PLASMAMAN, SPECIES_ETHEREAL, "other")
...
/obj/machinery/limbgrower/proc/build_limb(buildpath)
	...
	var/list/greyscale_species = list(SPECIES_HUMAN, SPECIES_LIZARD, SPECIES_ANTHROPOMORPH, SPECIES_ETHEREAL)
